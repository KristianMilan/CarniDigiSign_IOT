...
function formatDate(date) {
  ...
  return date.getMonth()+1 + "/" + date.getDate() + "/" + date.getFullYear() + "  " + strTime + ' UTC';
}
...
exports = async function(payload,response) {
  ...
  r = r + "<thead class='thead-dark'><tr><th>MAC</th><th>IP</th><th>Token</th><th>Location</th><th>Last Seen</th><th>Link</th></tr></thead><tbody>";
